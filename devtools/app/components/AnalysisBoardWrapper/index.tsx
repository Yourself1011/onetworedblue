...
export default function AnalysisBoardWrapper() {
    ...
    useEffect(() => {
        ...
        const handler = (event: ErrorEvent) => {
            ...
            const mentionsSharedArrayBuffer =
                message.includes("SharedArrayBuffer");
            const mentionsStockfish = message
                .toLowerCase()
                .includes("stockfish");
            ...
            try {
                ...
                if (typeof data.lastRestartAt === "number") {
                    ...
                    if (!prev || current > prev) {
                        ...
                        const reason = data.lastRestartReason as
                            | string
                            | null
                            | undefined;
                        if (reason === "manual") {
        ...
        <div className="h-full w-full grid place-items-center">
            <div>
                <div className="text-center mb-4">
                    ...
                    <p>
                        See{" "}
                        <span className="text-sm p-1 rounded font-mono">
                            README.md
                        </span>{" "}
